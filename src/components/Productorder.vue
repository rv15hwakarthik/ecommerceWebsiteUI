<template>
  <div class="container" style="margin-top:60px;">
    <h1 align="center" style="font-family:sans-serif; margin-top:50px">Detailed Order History</h1>
    <div v-for="(item,i) in orderProducts" :key="item.name">
      <v-container>
        <v-layout>
          <v-flex md8 offset-md2 style="">
            <v-card >
              <v-layout>
                <v-flex>
                  <div style="font-family : sans-serif; padding:20px; background-color:#ededed">
                    ...
                    <v-btn color="#ededed" @click="addreview(i)">Submit</v-btn>
                  </div>
                </v-flex>
              </v-layout>
            </v-card>
