      ...
      <div class="text-xs-center" style="margin-top:150px">
        ...
        <v-layout>
          <v-flex md4 offset-md1>
            <v-card color="blue"><div style="color:white; text-align:left; font-family:sans-serif; font-size:250%; margin-left:28px; padding:5px; padding-top:20px"><b>Sign In</b><v-icon>supervisor_account</v-icon></div>
